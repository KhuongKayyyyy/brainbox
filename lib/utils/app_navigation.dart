...
class AppNavigation {
  ...
  static final _shellNavigatorAssistantKey = GlobalKey<NavigatorState>(debugLabel: "shellAssistant");
  static final _shellNavigatorHistoryKey = GlobalKey<NavigatorState>(debugLabel: "shellHistory");
  static final _shellNavigatorAccountKey = GlobalKey<NavigatorState>(debugLabel: "shellAccount");
  ...
  static final GoRouter router = GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        ...
        builder: (BuildContext context, GoRouterState state) => PhoneVerificationPage(),
      ),
      GoRoute(
          ...
          StatefulShellBranch(
            ...
            routes: [
              GoRoute(
                ...
                builder: (BuildContext context, GoRouterState state) => HomeLandingPage(),
              )
            ]
          ),
          ...
          StatefulShellBranch(
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (BuildContext context, GoRouterState state) => AssistantLandingPage(),
                )
              ]
          ),
          ...
          StatefulShellBranch(
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (BuildContext context, GoRouterState state) => HistoryLandingPage(),
                )
              ]
          ),
          ...
          StatefulShellBranch(
              ...
              routes: [
                GoRoute(
                  ...
                  builder: (BuildContext context, GoRouterState state) => AccountLandingPage(),
                )
              ]
          ),
